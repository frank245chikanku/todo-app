        ...
        >
            <div className="w-96 rounded-xl shadow shadow-white text-white bg-black flex flex-col justify-center p-4">
                ...
                <div className="mt-4 flex flex-col w-full">
                    <input className="p-3 rounded text-black" placeholder="username" type="text" />
                    <input className="mt-4 p-3 rounded text-black" placeholder="email" type="text" />
                    <input className="mt-4 p-3 rounded text-black" placeholder="password" type="password" />
                </div>
                <button className="mt-4 p-3 bg-[#ee5522] rounded font-bold hover:bg-[#e2724d]">Register</button>
